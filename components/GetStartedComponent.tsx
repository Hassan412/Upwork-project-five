...
const Getstarted = [
  {
    ...
    icon: "/Images/spotify-step-1.png",
  },
  {
    ...
    icon: "/Images/spotify-step-2.png",
  },
  {
    ...
    icon: "/Images/spotify-step-3.png",
  },
];
    ...
    <section className="flex flex-col gap-8 py-16 justify-center items-center ">
      ...
      <div className="flex flex-col lg:flex-row gap-20 justify-between items-center md:px-16 lg:px-32 w-full">
        ...
        <Image
          ...
          fill
          alt="getstarted"
          className="drop-shadow-[2px_2px_2px_rgba(77,234,127,0.9)]  object-contain"
        />
        </div>
      </div>
      <a href="#" className="py-4 px-8 mt-16 !rounded-full sm:px-16 sm:py-6 tracking-normal !text-white font-bold sm:text-xl bg-gradient-to-r from-[#24C48C] to-[#2EC560] ">
        Grow My Spotify
      </a>
    </section>
  );
